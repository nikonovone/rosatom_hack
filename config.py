...
# data settings
data = "data_defect"
dataset_path = "data_defect/images"  # parent directory of datasets
class_name = "dataset"  # dataset subdirectory
modelname = "detection_model"  # export evaluations/logs with this name
